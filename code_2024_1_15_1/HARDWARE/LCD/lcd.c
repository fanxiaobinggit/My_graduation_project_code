...
//清屏函数
//color:要清屏的填充色
void LCD_Clear_part(u16 x,u16 y,u16 width ,u16 height,u16 color)
{
    u32 index = 0;
    u32 totalpoint = width;
...
void LCD_ShowFloatNum(u16 x, u16 y,float num,u8 float_n,u8 size)
{
    ...
    uint32_t xiaoshu=0;
    uint8_t zhengshu_counter=0;
    volatile uint8_t xiaoshu_counter=0;
    ...
    LCD_ShowChar ((x+size*zhengshu_counter/2), y, '.', size,0);            //显示小数点
